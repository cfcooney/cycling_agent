...
from ..tools.tools import (
    ...
    UserStravaRoutesTool,
    find_cycling_climb_articles,
    scrape_and_extract_climb_stats,
)
from ..prompts.system_prompt import advanced_agent_system_prompt
...
class ConversationalCyclingAgent:
    ...
    def display_welcome(self):
        ...
        welcome_text = Text()
        welcome_text.append(
            "🚴 Welcome to your Cycling Assistant! 🚴\n", style="bold cyan"
        )
        welcome_text.append(
            "I can help you find bike rentals, cycling routes, and local cycling advice.\n\n"
        )
    ...
    def handle_command(self, user_input: str) -> bool:
        ...
        if command == "help":
            ...
            self.console.print(
                "[cyan]👋 Thanks for using Cycling Assistant! Happy cycling![/cyan]"
            )
            return True
    ...
    def process_user_input(self, user_input: str) -> Optional[str]:
        ...
        try:
            ...
            self.console.print(
                "[dim]Please try rephrasing your question or check your configuration.[/dim]"
            )
            return None
            ...
            while True:
                ...
                if self.handle_command(user_input):
                    ...
                    if user_input.lower().startswith(
                        "/quit"
                    ) or user_input.lower().startswith("/exit"):
                        break
                    continue
